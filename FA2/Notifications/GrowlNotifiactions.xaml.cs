...
namespace FA2.Notifications
{
    public partial class GrowlNotifiactions
    {
        ...
        private int _count;
        public FAII.Notifications.Notifications Notifications = new FAII.Notifications.Notifications();
        private readonly FAII.Notifications.Notifications _buffer = new FAII.Notifications.Notifications();
